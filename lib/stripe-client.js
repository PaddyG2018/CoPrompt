...
/**
 * Get price ID for package type (live mode price IDs)
 */
function getPriceId(packageType) {
  // These should match your actual Stripe price IDs from the dashboard
  const priceIds = {
    starter: 'price_1RgldFCTqmLMMgD0HUTrpECH', // $5.00 for 50 credits
    power: 'price_1RgldGCTqmLMMgD0SVpX2BdG',   // $15.00 for 200 credits  
    pro: 'price_1RgldGCTqmLMMgD0CuFkgQDd'      // $30.00 for 500 credits
  };
